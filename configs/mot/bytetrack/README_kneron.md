...
python tools/train.py \
    configs/mot/bytetrack/bytetrack_yolox_s_crowdhuman_mot17-private-half_leaky.py
```
...
python tools/test.py \
    configs/mot/bytetrack/bytetrack_yolox_s_crowdhuman_mot17-private-half_leaky.py \
    --checkpoint work_dirs/bytetrack_yolox_s_crowdhuman_mot17-private-half_leaky/epoch_80.pth \
    --out results.pkl \
    --eval bbox
```
...
python tools/deployment/pytorch2onnx.py \
    configs/mot/bytetrack/bytetrack_yolox_s_crowdhuman_mot17-private-half_leaky.py \
    work_dirs/bytetrack_yolox_s_crowdhuman_mot17-private-half_leaky/epoch_80.pth \
    --skip-postprocess \
    --shape 800 1440
``
